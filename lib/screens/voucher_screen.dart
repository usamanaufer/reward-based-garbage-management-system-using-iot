...
class VoucherClaim extends StatefulWidget {
  @override
  _VoucherClaimState createState() => _VoucherClaimState();
}

class _VoucherClaimState extends State<VoucherClaim> {
  ...
  var PagesAll = [HomeScreen(), VoucherClaim(), HomeScreen()];
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () async =>
                            await redeemVoucherClaim().whenComplete(
